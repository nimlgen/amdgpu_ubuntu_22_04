...
AC_DEFUN([AC_CONFIG_KERNEL], [
	...
	AC_AMDGPU_DRM_PANEL_BACKLIGHT_QUIRK
	...
	AC_AMDGPU_DRM_CONNECTOR_STRUCT_MEMBER
	...
	AC_AMDGPU_STRUCT_DRM_PRIVATE_OBJS_STATE
	...
	AC_AMDGPU_DRM_GEM_DMABUF_VMAP_HAS_IOSYS_MAP_ARG
	...
	AC_AMDGPU_ATTRIBUTE_GROUP_BIN_ATTRS_NEW
	...
	AC_AMDGPU_TIME64_TO_TM
	AC_AMDGPU_DRM_MEMORY_STATS
	AC_AMDGPU_DRM_CONNECTOR_DYNAMIC_INIT
	AC_AMDGPU_MODULE_IMPORT_NS
	AC_AMDGPU_DRM_DEV_WEDGED_EVENT
	AC_AMDGPU_SHMEM_READ_FOLIO
	AC_AMDGPU_DRM_DRIVER_DATE
	AC_AMDGPU_STRSCPY_ALLOW_TWO_ARGUMENTS
	AC_AMDGPU_DMA_FENCE_ARRAY_FIRST
	AC_AMDGPU_DMA_FENCE_DEDUP_ARRAY
	AC_AMDGPU_DRM_FILE_ERR
	AC_AMDGPU_DRM_FILE_CLIENT_NAME
	AC_AMDGPU_SIZE_MUL
	AC_AMDGPU_RANGE_OVERFLOWS
	AC_AMDGPU_DRM_CRTC_HELPER_MODE_VALID_FIXED
	AC_AMDGPU_BIN_ATTR_CONST_ARGS
	AC_AMDGPU_DRMM_CGROUP_REGISTER_REGION
	AC_AMDGPU_HRTIMER_SETUP
	AC_AMDGPU_RATELIMIT_STATE_RESET_INTERVAL
	AC_AMDGPU_TIMER_DELETE
	AC_AMDGPU_IRQ_DOMAIN_CREATE_LINEAR
	AC_AMDGPU_SHMEM_WRITEOUT
	AC_AMDGPU_KMAP_LOCAL_PAGE_TRY_FROM_PANIC
	AC_AMDGPU_PM_HIBERNATE_IS_RECOVERING
	AC_AMDGPU_PM_HIBERNATION_MODE_IS_SUSPEND
	AC_AMDGPU_DRM_GEM_IS_IMPORTED
	AC_AMDGPU_DMA_FENCE_INIT64
	AC_AMDGPU_DRM_FILE_DEBUGFS_CLIENT
	AC_AMDGPU_DRM_VBLANK_CRTC_STRUCT_CONFIG
	AC_AMDGPU_DRM_CONNECTOR_UPDATE_PRIVACY_SCREEN
	AC_AMDGPU_DRM_DP_AUX_DPCD_PROBE_DISABLED
	AC_AMDGPU_BLOCK_DEVICE_BD_DEVICE
	AC_AMDGPU_PAGE_PGMAP
	AC_AMDGPU_VMEMDUP_ARRAY_USER
	AC_AMDGPU_BITMAP_READ
	AC_AMDGPU_VMF_INSERT_MIXED_MKWRITE_LONG_PFN
	AC_AMDGPU_DRM_HELPER_MODE_FILL_FB_STRUCT
	AC_AMDGPU_DRM_FB_CREATE_FORMAT_INFO
	AC_AMDGPU_DRM_GET_FORMAT_INFO_2_ARGS
	AC_AMDGPU_VFS_IOCB_ITER_READ
	AC_AMDGPU_LIST_IS_HEAD
	AC_AMDGPU_DEVM_I2C_ADD_ADAPTER
	AC_AMDGPU_MEMPOOL_ALLOC_PREALLOCATED
	AC_AMDGPU_KFD_PEERDIRECT_SUPPORT
	AC_AMDGPU_SYSTEM_PERCPU_WQ
